...
export const AfterSaleStep = (props: AfterSaleStepProps) => {
  ...
  if (info.refundStatus === SaleStatusEnum.PENDING_AUDIT.value) {
    return (
      <Steps className="py-[24px] rounded-lg" value={1} direction="vertical">
        <Steps.Step>
          <View>提交申请</View>
        </Steps.Step>
        <Steps.Step>
    ...
    return (
      <Steps className="py-[24px] rounded-lg" value={2} direction="vertical">
        <Steps.Step>
          <View>提交申请</View>
        </Steps.Step>
        <Steps.Step>
    ...
    return (
      <Steps className="py-[24px] rounded-lg" value={3} direction="vertical">
        <Steps.Step>
          <View>提交申请</View>
        </Steps.Step>
        <Steps.Step>
    ...
    return (
      <Steps className="py-[24px] rounded-lg" value={4} direction="vertical">
        <Steps.Step>
          <View>提交申请</View>
        </Steps.Step>
        <Steps.Step>
    ...
    return (
      <Steps className="py-[24px] rounded-lg" value={5} direction="vertical">
        <Steps.Step>
          <View>提交申请</View>
        </Steps.Step>
        <Steps.Step>
