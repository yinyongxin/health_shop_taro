...
export type GetWxShopOrderReceiveData = {
  body?: never;
  path?: never;
  query?: {
    /**
...
export type GetWxShopOrderReceiveErrors = {
  400: {
    code: number;
    msg: string;
  };
...
export type GetWxShopOrderReceiveError =
  GetWxShopOrderReceiveErrors[keyof GetWxShopOrderReceiveErrors];

export type GetWxShopOrderReceiveResponses = {
  200: {
    code: number;
    msg: string;
    data?:
...
export type GetWxShopOrderReceiveResponse =
  GetWxShopOrderReceiveResponses[keyof GetWxShopOrderReceiveResponses];

export type GetWxShopOrgListData = {
  body?: never;
  path?: never;
  query?: never;
...
export type GetWxShopOrgListErrors = {
  400: {
    code: number;
    msg: string;
  };
...
export type GetWxShopOrgListError =
  GetWxShopOrgListErrors[keyof GetWxShopOrgListErrors];
